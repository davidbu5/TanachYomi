...
export function createMesoraSmallExcelFromWeeks(weeks: Day[][], yearNum?: number, objectToWriteOn?: any) {
    ...
    wb.write(`${yearNum ? yearNum + " " : ""}RegularSmall.xlsx`, objectToWriteOn)
}
